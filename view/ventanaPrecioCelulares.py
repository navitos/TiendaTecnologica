...
class VentanaPrecioCelulares:
    def __init__(self, root, controlador_tienda):
        ...
        self.ventana.title("Precio Total de Celulares")
        ...
        precio_total = self.controlador_tienda.calcular_total_celulares()

        # Mostrar el precio total en la ventana
        Label(self.ventana, text=f"Precio total de los celulares: ${precio_total:.2f}", font=("Arial", 10)).pack(pady=20)
